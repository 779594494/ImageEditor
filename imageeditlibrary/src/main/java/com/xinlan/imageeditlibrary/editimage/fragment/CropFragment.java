...
//		dataList.add(new RatioItem("1:3", 1 / 3f));
		...
		dataList.add(new RatioItem("9:16", 9 / 16f));
		dataList.add(new RatioItem("16:9", 16 / 9f));

	}
	private List<TextView> textViewList = new ArrayList<TextView>();

	public static int SELECTED_COLOR = R.color.hint_foreground_crop;
	...
	private void setUpRatioList() {
		...
		int[] ifliters={R.drawable.cj_ico1,R.drawable.cj_ico2,
				R.drawable.cj_ico5,R.drawable.cj_ico6,R.drawable.cj_ico7,R.drawable.cj_ico8,
				R.drawable.cj_ico9,R.drawable.cj_ico10,R.drawable.cj_ico11,R.drawable.cj_ico12};
		...
		for (int i = 0, len = dataList.size(); i < len; i++) {
			...
			text.setTextSize(14);
			if (dataList.get(i).getText().equals("自定义")){
		...
		selctedTextView.setTextColor(getActivity().getResources().getColor(R.color.hint_foreground_crop));
	}
