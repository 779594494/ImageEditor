...
public class EditImageActivity extends BaseActivity {
    ...
    public static final int MODE_BEAUTY = 8;//美颜模式
    public static final int MODE_MOSAI = 7;//马赛克模式模式
    ...
    public MosaicFragment mMosaicFragment;//马赛克模式
    ...
    private void initView() {
        ...
        bottomGallery.setOffscreenPageLimit(8);
        ...
        mMosaicFragment = MosaicFragment.newInstance(this);
        ...
        mRedoUndoController = new RedoUndoController(this,mainImage, findViewById(R.id.redo_uodo_panel));
    }
        ...
        public void onClick(View v) {
            switch (mode) {
                ...
                case MODE_PAINT://保存涂鸦
                    ...
                    break;
                case MODE_MOSAI://保存马赛克后的图片
                    mMosaicFragment.saveMosaiImage();
                    break;
